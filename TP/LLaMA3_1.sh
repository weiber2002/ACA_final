#!/bin/bash
#SBATCH --job-name=load_llama3_8b_2GPU      # 工作名稱
...
#SBATCH -o load_llama3_8b_2GPU_%j.log        # output file (%j expands to jobId)
#SBATCH -e load_llama3_8b_2GPU_%j.err        # output file (%j expands to jobId)


CONDA_PREFIX="/work/HPC_software/LMOD/miniconda3/miniconda3_app/24.11.1"
CONDA_DEFAULT_ENV="ACA_TP" # 你的 conda 環境名稱

$CONDA_PREFIX/bin/conda run -n "$CONDA_DEFAULT_ENV" torchrun --master-port=29501 --nproc_per_node=2 LLaMA3_1.py